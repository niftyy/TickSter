...
import { NotFoundError, requireAuth, validateRequest, OrderStatus, BadRequestError } from '@tickster/common';
...
async (req: Request, res: Response) => {
  ...
  // ticket we just received and the orders status is *not cancelled*.
